...
function forward(title_short) {
    ...
    //     sleep(1000);
    //     console.log("找不到文件传输助手，滑动寻找……");
    //     swipe(device_w / 2, device_h * 0.8, device_w / 2, device_h * 0.5, 1000);
    //     // className("android.widget.ListView").depth(9).findOne().scrollForward();
    // }
    ...
    text("文件传输助手").waitFor();
    sleep(1500);
    let wjcs_click = text("文件传输助手").findOne().parent().parent().parent().parent().parent().parent().click();
